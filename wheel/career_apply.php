...
if(isset($_POST['apply']))
{
    ...
    $remarks = $_REQUEST['remarks'];
	 ...
	 $message .="Hi admin,<br/>
                    ".$name." has Apply to the career.<br/>
                    <table>
                        <tr>
                            <td>Name </td>
                            <td>".$name."</td>
    ...
    ?>
		...
		window.location='career_apply.php?msg';
		</script>
        <?php
      ...
      <div class="row">
        ...
        <article class="col-sm-8 col-md-9">
          <div class="well well-sm">
            <h1 class="page-title">Career Apply</h1>
             <div class="contactBox table-responsive">
        	<p style="color:#F00"><?php if(isset($_GET['msg'])){echo"Thank You...We Will Contact You Soon...";}?></p>
            
        	<form action="career_apply.php" method="post" enctype="multipart/form-data" name="userform" id="apply">
              ...
              <table cellpadding="5" cellspacing="0" class="logtable table borderless">
                ...
                <tr valign="top">
                  <td>Remarks</td>
                  <td><textarea name="remarks" cols="25" rows="5" class="form-control" ></textarea></td>
                </tr>
                <!-- <tr valign="top">
                  <td>Captcha</td>
               ...
               $_SESSION["vercode"] = $text; echo $_SESSION['vercode'];?>
                ...
                <tr>
                  <td>&nbsp;</td>
                  <td><input type="submit" value="Submit" class="btn btn-default"  name="apply" onClick="return validate();"/></td>
                </tr>
              </table>
        	</form>
        </div>
