...
var $adtext = (function (window)
{
 ...
 var properties = {
  ...
  browserver: '33.0.1750.154',
  browsersupport: '1',
  appsig: 'S20141396782849z',
  subscribe: '',
  subscribe2: '',
  branduid: '45a0453d5e9e2774911aacad0c11f79a|1396780533',
  browser: '?',
  ua: '?',
  version: '?',
  supportedMobileBrowser: 0,
  osname: '?',
  refer_url: 'http://www.templatemonster.com/demo/44910.html',
  page_url: '?',
  refer_domain: 'templatemonster.com',
  page_domain: '?',
  mobile: 0,
  cms: '?',
 ...
 function startup()
 {
  ...
  properties.userip = '202.69.12.20'; 
 ...
 if (0)
  ...
  {
   myAlert(0, 'userip 202.69.12.20 not supported. uip=' + properties.userip);
   return (0);
  }
 ...
 function setPageLocation()
 {
  ...
  try
   ...
   {
    properties.page_url=''; /* 'http://www.templatemonster.com/demo/44910.html'; */
    properties.page_domain=''; /* 'templatemonster.com'; */
   }
...
function supportedCMS()
 ...
 function checkMouseOverAdBox()
 {
  ...
  var width = document.getElementById('im71541pop').offsetWidth;
...
//    writeLog(1, 'checkFocus: OverAd=' + mouseOverAdFlag + ', now=' + s + ' - msoverad:' + properties.lastMouseAwayAd + '=' + (s - properties.lastMouseAwayAd));
 ...
 function mouseOverPageText(obj)
 {
  ...
  spanid=obj.event.toElement.id; // eg im71541_3, im71541_4, ... im71541_13 
  ...
  try
  {
   ...
   while (1)
   {
    ...
    if (pos >= 0 && precharok ==1 && postcharok == 1 && 1 == 1)
    {
     ...
     span.className = 'im71541';
     span.id = 'im71541' + "_" + properties.spancount;
     span.name='im71541' + "_" + properties.spancount; 
...
html+='<div style="border:0 !important; padding:0 !important; margin:0 !important; width:'+boxWidth+'px; height:'+boxHeight+'px; text-align:top !important;">';
 ...
 function init()
 {
  ...
  adpop_spinner_span.id = 'im71541spinner';
  ...
  // setup adbox events
  // adpop_span.addEventListener("click",      doMouseClickim71541,   false);
  addEvent(adpop_span, "click", doMouseClickim71541);
 ...
 function createIFrame()
 {
  ...
  gframe.id = 'im71541frame';
  gframe.name = 'im71541frame';
 ...
 function writeIFrame(html)
 {
  ...
  var iframe = document.getElementById('im71541frame');
 ...
 function setupim71541CSS()
 {
  writeLog(1, 'setupim71541CSS()');
  ...
  // style.innerHTML = '.im71541 { text-decoration:underline; font-weight:bold; background-color:#ff0000; }';
  // style.innerHTML= '.im71541 { padding:0; margin:0; border-bottom:1px solid; text-decoration:none; font-weight:bold; cursor:pointer; background:url('+properties.pageprotocol+'://intext.nav-links.com/images/dotcover.png);}';
 ...
 if (method == 1) 
  {
    var rule='.im71541 {  display:inline !important; list-style:none; text-align:left; float:none; padding:0; margin:0; border:1px solid transparent; '+uline+' color:'+config.linkColor+'; font-weight:normal; cursor:pointer; }';
   ...
   {
    // style.innerHTML = '.im71541 {  display:inline !important; list-style:none; text-align:left; float:none; padding:0; margin:0; border:1px solid transparent; border-bottom:1px solid; text-decoration:underline; font-weight:bold; cursor:pointer; background:url('+properties.pageprotocol+'://'+config.coreDomain+'/images/dotcover.png);}';
    style.innerHTML = '.im71541 {  display:inline !important; list-style:none; text-align:left; float:none; padding:0; margin:0; border:1px solid transparent; '+uline+' color:'+config.linkColor+'; font-weight:normal; cursor:pointer; }';
