<%@ page title="" language="C#" masterpagefile="~/ControlPanel/Admin.master" autoeventwireup="true" inherits="ControlPanel_MyProfile, App_Web_jx024tsd" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $.when(fnLoadUserTypes()).done(function(){
            fnLoadUserDetails();
...
//lblUserType lblName lblUsername lblEmail lblDOB lblPhone lblMobile lblAddress lblPostCode lblCity lblState lblCountry lblCreatedOn
                        $.each(obj, function (index, value) {

                            $("#hfUserID").val(value.iUserAccountID);
                            $("#ddlUserTypes").val(value.iUserTypeID);
                            $("#lblUserType").text($("#ddlUserTypes option:selected").text());
            ...
            <div class="box span12">
                ...
                <div class="box-content">
                    ...
                    <dl class="dl-horizontal">
                        <dt>Profile Pic:</dt>
                        <dd>
                            <img id="imgProfilePic" alt="Profile Pic" src="ico/apple-touch-icon-144-precomposed.png"
