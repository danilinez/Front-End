<%@ page title="" masterpagefile="~/ControlPanel/AdminPanel.master" language="C#" enableeventvalidation="true" maintainscrollpositiononpostback="true" autoeventwireup="true" inherits="ControlPanel_ManageCase, App_Web_zarixrtn" %>
                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    <td width="63" align="right">
                                                                                                                        <asp:ImageButton ID="imgBtnPatientSave" ImageUrl="images/btn-save.png" runat="server"
                                                                                                                            OnClick="imgBtnPatientSave_Click" ValidationGroup="validatePateintInfo" CausesValidation="true" />
                                                                                                                    </td>
                                                                                                                    <td style="width: 10px;">
                                                                                                                    </td>
                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    <td>
                                                                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                                                            <tr>
                                                                                                                                <td width="151" align="left">
                                                                                                                                    Title:<asp:RequiredFieldValidator ID="RequiredFieldValidator4" ForeColor="Maroon"
                                                                                                                    ...
                                                                                                                    <td>
                                                                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                                                            <tr>
                                                                                                                                ...
                                                                                                                                <td align="left">
                                                                                                                                    <asp:TextBox ID="txtDocumentDescription" TextMode="MultiLine" runat="server" CssClass="field-220"
                                                                                                                                        Rows="6">
                                                                                                                                    </asp:TextBox>
                                                                                                                                </td>
                                                                                                                            </tr>
                                                                                                                    ...
                                                                                                                    <td>
                                                                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                                                            <tr>
                                                                                                                                ...
                                                                                                                                <td align="left">
                                                                                                                                    <iframe frameborder="0" scrolling="no" height="50px" src="uploading.aspx?uploadType=CV"
                                                                                                                                        style="padding: 0px; width: 100%; background-color: Transparent;">[Your browser
                                                                                                                                        does not support frames] </iframe>
                                                                                                                                    <%-- <asp:FileUpload ID="fluUploadDocument" runat="server" CssClass="field-220" />--%>
                                                                                                                                </td>
                                                                                                                            </tr>
                                                                                                                        </table>
                                                                                                                    </td>
                                                                                                                    ...
                                                                                                                    <td>
                                                                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                                                            <tr>
                                                                                                                                ...
                                                                                                                                <td align="left">
                                                                                                                                    <asp:Label ID="lblDocumentError" runat="server" Text="-" Visible="false"></asp:Label>
                                                                                                                                </td>
                                                                                                                            </tr>
                                                                                                                        </table>
                                                                                                                    </td>
                                                                                                                                        ...
                                                                                                                                        <tr>
                                                                                                                                            <td width="63" align="right">
                                                                                                                                                <asp:ImageButton ID="imgbtnSaveFile" ImageUrl="images/btn-save.png" runat="server"
                                                                                                                                                    ValidationGroup="validatePateintDocument" CausesValidation="true" OnClick="imgbtnSaveFile_Click" />
                                                                                                                                            </td>
                                                                                                                                            <td style="width: 10px;">
                                                                                                                                            </td>
                                                                                                                                            <td width="63" align="left">
                                                                                                                ...
                                                                                                                <asp:ListView ID="lvDocument" runat="server" OnItemCommand="lvDocument_ItemCommand">
                                                                                                                    ...
                                                                                                                    <ItemTemplate>
                                                                                                                        <tr>
                                                                                                                            ...
                                                                                                                            <td class="grid-border-bottom">
                                                                                                                                <a href='../UploadedCaseDocuments/<%# Eval("sDocumentPath")%>' target="_blank">
                                                                                                                                ...
                                                                                                                                <asp:ImageButton ID="imgbtnDeleteDocuments" ImageUrl="images/icon-delete.png" CommandArgument='<%# Eval("iDocumentID")%>'
                                                                                                                                    CommandName="DeleteDocument" runat="server" OnClientClick="javascript:if(confirm('Are you sure you want to delete this Document?')) return true; else return false;" />
                                                                                                                            </td>
                                                                                                                        </tr>
                                                                                                                    </ItemTemplate>
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td align="center">
                                                                                                            <table width="197" border="0" align="center" cellpadding="0" cellspacing="0">
                                                                                                                <tr>
                                                                                                                    <td width="63" align="right">
                                                                                                                        <asp:ImageButton ID="imgBtnSaveQA" ImageUrl="images/btn-save.png" runat="server"
                                                                                                                            OnClick="imgBtnSaveQA_Click" CausesValidation="true" ValidationGroup="validateGeneralQA" />
                                                                                                                    </td>
                                                                                                                    <td style="width: 10px;">
                                                                                                                    </td>
                                                                                                                    <td width="63" align="left">
                                                                                                                        <asp:ImageButton ID="imgBtnCancelQA" ImageUrl="images/btn-cancel.png" runat="server"
                                                                                                                            OnClick="imgBtnCancelQA_Click" CausesValidation="false" />
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                            </table>
                                                                                                        </td>
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td align="center">
                                                                                                            <table width="197" border="0" align="center" cellpadding="0" cellspacing="0">
                                                                                                                <tr>
                                                                                                                    <td width="63" align="right">
                                                                                                                        <asp:ImageButton ID="imgBtnSaveDetailsQA" ImageUrl="images/btn-save.png" runat="server"
                                                                                                                            CausesValidation="false" OnClick="imgBtnSaveDetailsQA_Click" />
                                                                                                                    </td>
                                                                                                                    <td style="width: 10px;">
                                                                                                                    </td>
                                                                                                                    <td width="63" align="left">
                                                                                                                        <asp:ImageButton ID="ImageButton2" ImageUrl="images/btn-cancel.png" runat="server"
                                                                                                                            OnClick="imgBtnCancelQA_Click" CausesValidation="false" />
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                            </table>
                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    <td>
                                                                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                                                            <tr>
                                                                                                                                <td width="151" align="left">
                                                                                                                                    Question:<asp:RequiredFieldValidator ID="RequiredFieldValidator5" ForeColor="Maroon"
                                                                                                                    ...
                                                                                                                    <td>
                                                                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                                                            <tr>
                                                                                                                                ...
                                                                                                                                <td align="left">
                                                                                                                                    <asp:TextBox ID="txtDQAAnswer" TextMode="MultiLine" runat="server" CssClass="field-220"
                                                                                                                                        Rows="6">
                                                                                                                                    </asp:TextBox>
                                                                                                                                </td>
                                                                                                                            </tr>
                                                                                                                                        ...
                                                                                                                                        <tr>
                                                                                                                                            <td width="63" align="right">
                                                                                                                                                <asp:ImageButton ID="imgBtnDQASave" ImageUrl="images/btn-save.png" runat="server"
                                                                                                                                                    OnClick="imgBtnDQASave_Click" ValidationGroup="validateDQA" CausesValidation="true" />
                                                                                                                                            </td>
                                                                                                                                            <td style="width: 10px;">
                                                                                                                                            </td>
                                                                                                                                            <td width="63" align="left">
                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    <td width="478" align="left" colspan="2">
                                                                                                                        <table>
                                                                                                                            <tr>
                                                                                                                                <td>
                                                                                                                                    <asp:Button ID="btnAddProduct" CssClass="gbtn_s" runat="server" Text="Save" OnClick="btnAddProduct_Click"
                                                                                                                                        CausesValidation="true" ValidationGroup="validateOrderInformation" />
                                                                                                                                </td>
                                                                                                                                <td>
                                                                                                                                </td>
                                                                                                                                <td>
                                                                                                                                    <asp:Button ID="btnCancelProduct" CssClass="gbtn_s" runat="server" Text="Cancel"
                                                                                                                                    ...
                                                                                                                                    <tr>
                                                                                                                                        ...
                                                                                                                                        <td class="grid-border-bottom">
                                                                                                                                            ...
                                                                                                                                            <asp:ImageButton ID="imgbtnDeleteQA" ImageUrl="images/icon-delete.png" CommandArgument='<%# Eval("iOrderDetailID")%>'
                                                                                                                                                CommandName="DeleteProduct" runat="server" OnClientClick="javascript:if(confirm('Are you sure you want to delete this Medicine?')) return true; else return false;" />
                                                                                                                                        </td>
                                                                                                                                    </tr>
                                                                                                                                </ItemTemplate>
                                                                                                                                <AlternatingItemTemplate>
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td align="center">
                                                                                                            <table width="197" border="0" align="center" cellpadding="0" cellspacing="0">
                                                                                                                <tr>
                                                                                                                    <td width="63" align="right">
                                                                                                                        <asp:ImageButton ID="imgbtnOISave" ImageUrl="images/btn-save.png" runat="server"
                                                                                                                            OnClick="imgbtnOISave_Click" />
                                                                                                                    </td>
                                                                                                                    <td style="width: 10px;">
                                                                                                                    </td>
                                                                                                                    <td width="63" align="left">
                                                                                                                        <asp:ImageButton ID="imgbtnOICancel" ImageUrl="images/btn-cancel.png" runat="server"
                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    ...
                                                                                                                    <td width="403" align="left" valign="top">
                                                                                                                        <table>
                                                                                                                            <tr>
                                                                                                                                ...
                                                                                                                                <td>
                                                                                                                                    <asp:Button ID="btnAddNote" CssClass="default_button_3" runat="server" Text="Add Note"
                                                                                                                                        OnClick="btnAddNote_Click" />
                                                                                                                                </td>
                                                                                                                                <td>
                                                                                                                                    <asp:Button ID="btnCancelNote" CssClass="default_button_3" runat="server" Text="Cancel"
                                                                                                                                        OnClick="btnCancelNote_Click" />
                                                                                                                                </td>
                                                                                                                            </tr>
                                                                                                                        </table>
                                                                                                                    </td>
                                                                                                                    <td width="400" align="left" colspan="2" valign="top">
                                                                                                                        <table width="100%" class="grid" border="0" cellspacing="0" cellpadding="0">
                                                                                                                            ...
                                                                                                                            <asp:ListView ID="lvNotes" runat="server" OnItemCommand="lvNotes_ItemCommand">
                                                                                                                                <LayoutTemplate>
                                                                                                                                    <tbody>
                                                                                                                                        <asp:PlaceHolder ID="itemPlaceHolder" runat="server" />
                                                                                                                                    </tbody>
                                                                                                                                    ...
                                                                                                                                    <tr>
                                                                                                                                        ...
                                                                                                                                        <td class="grid-border-bottom">
                                                                                                                                            ...
                                                                                                                                            <asp:ImageButton ID="imgbtnDeleteQA" ImageUrl="images/icon-delete.png" CommandArgument='<%# Eval("iCaseNoteID")%>'
                                                                                                                                                CommandName="DeleteNote" runat="server" OnClientClick="javascript:if(confirm('Are you sure you want to delete this Note?')) return true; else return false;" />
                                                                                                                                        </td>
                                                                                                                                    </tr>
                                                                                                                                </ItemTemplate>
                                                                                                                                <AlternatingItemTemplate>
