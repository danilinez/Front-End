<%@ page title="" language="C#" masterpagefile="~/ControlPanel/AdminPanel.master" autoeventwireup="true" inherits="ControlPanel_ManageCases_V2, App_Web_zarixrtn" %>
                                                        ...
                                                        <tr>
                                                            <td height="5">
                                                                <table>
                                                                    <tr>
                                                                        <td>
                                                                            <asp:Button ID="btnAddNewCase" CssClass="gbtn_s" runat="server" Text="Add Case" CausesValidation="False"
                                                                                OnClick="btnAddNewCase_Click" />
                                                                        </td>
                                                                        <td>
                                                                        </td>
                                                                    </tr>
                                                            ...
                                                            <td height="5">
                                                                <table width="100%" class="grid" border="0" cellspacing="0" cellpadding="0">
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <asp:Button ID="btnSearch" CssClass="gbtn_s" runat="server" Text="Search" CausesValidation="true"
                                                                    ...
                                                                    <asp:ListView ID="lstCase" runat="server" OnItemCommand="lstCase_ItemCommand">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <tr>
                                                                                ...
                                                                                <td class="grid-border-bottom">
                                                                                    <asp:ImageButton ID="btn_Edit" runat="server" CommandArgument='<%# Eval("iCaseID")%>'
                                                                                        CommandName="EditCase" ImageUrl="images/icon-view-edit.png" />
                                                                                    <asp:ImageButton ID="btn_Delete" runat="server" CommandArgument='<%# Eval("iCaseID")%>'
                                                                                        CommandName="DeleteCase" ImageUrl="images/icon-delete.png" />
                                                                                </td>
                                                                            </tr>
                                                                        </ItemTemplate>
