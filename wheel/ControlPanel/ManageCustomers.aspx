<%@ page title="" language="C#" masterpagefile="~/ControlPanel/AdminPanel.master" autoeventwireup="true" inherits="ControlPanel_ManageCustomers, App_Web_zarixrtn" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        var newEntry;
        var row;
        var idiContactID, idsGender, iddtDateOfBirth, idsPostCode, idsFirstName, idsLastName, idsPassword, idsAddress, idsEmail, idsUsername, idsName, idiUserID, idsTypeName, idiUserTypeID, hfAdminCompanyID, hfUserID, idsCountry;
        ...
        function FillEditDialog(editButton) {
            ...
            iddtDateOfBirth = $("#iddtDateOfBirth", row).text().replace(/^\s+/, "").replace(/^\s+|\s+$/g, "");
            idsCountry = $("#idsCountry", row).text().replace(/^\s+/, "").replace(/^\s+|\s+$/g, "");

            document.getElementById("lblTitle").innerHTML = "Edit Pateint";
        ...
        function DisplayEditDialog() {
            ...
            document.getElementById("<%= txtdob.ClientID %>").value = iddtDateOfBirth;
        ...
        function fnAddNewDialog() {
            ...
            var dropdownlistbox1 = document.getElementById("<%= ddlGender.ClientID %>")
            var dropdownlistbox2 = document.getElementById("<%= ddlCountry.ClientID %>")
            dropdownlistbox1.selectedIndex = 0;
            dropdownlistbox2.selectedIndex = 0;
        ...
        function UpdateValues(e) {
            ...
            var ctriddtDateOfBirth = document.getElementById("<%= txtdob.ClientID %>");
            ...
            if (ctriddtDateOfBirth.value.length < 1) {
                ctriddtDateOfBirth.focus();
            ...
            idsCountry = $("#<%= ddlCountry.ClientID %> option:selected").text();
            ...
            iddtDateOfBirth = document.getElementById("<%= txtdob.ClientID %>").value;
            ...
            $.ajax({
                type: "POST",
                url: "../LinezWS_WHCS.asmx/fnSaveCustomers",

                //, 'iCompanyID':'" + idiCompanyID + "'
                data: "{'iContactID':'" + idiContactID + "', 'iUserID':'" + idiUserID + "', 'strFirstName':'" + idsFirstName + "', 'strLastName':'" + idsLastName + "', 'strUsername':'" + idsUsername + "', 'strPassword':'" + idsPassword + "', 'strEmail':'" + idsEmail + "', 'strAddress':'" + idsAddress + "', 'strGender':'" + idsGender + "', 'strPostCode':'" + idsPostCode + "', 'iAdminCompanyID':'" + hfAdminCompanyID + "', 'newEntry':'" + newEntry + "', 'sCountry':'" + idsCountry + "', 'dtDateOfBirth':'" + iddtDateOfBirth + "'}",
                ...
                success: function (response) {
                    ...
                    if (result == 1) {
                        ...
                        $("#iddtDateOfBirth", row).text(iddtDateOfBirth);

                        $("#idsCountry", row).text(idsCountry);
                        $("#idsCountry", row).attr("title", idsCountry.toString());
                        CloseEditDialog();
                        ...
                        alert('Invalid PostCode/ZipCode');
                    }
                                                                    ...
                                                                    <asp:ListView ID="lstUsers" runat="server">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <tr>
                                                                                ...
                                                                                <td width="1" bgcolor="#CCCCCC">
                                                                                    <span id="idsCompanyName" title='<%# Eval("sCompanyName") %>' style="display: none;">
                                                                                ...
                                                                                <td class="grid-border-bottom">
                                                                                    <span id="iddtDateOfBirth" title='<%# Eval("dtDateOfBirth") %>'>
                                                                                        <%# Eval("dtDateOfBirth")%></span>
                                                                                </td>
                                                                                <td width="5" class="grid-border-bottom">
                                                                                </td>
                                                                                <td width="1" bgcolor="#CCCCCC">
                                                                                ...
                                                                                <asp:CheckBox ID="chkbActivate" runat="server" Checked='<%# Eval("btIsActive") %>' onchange="javascript:fnUpdateUserStatus(this);" />
                                                                                    <%--<input id="chkbActivate" type="checkbox" checked='<%# Eval("btIsActive") %>' onchange="javascript:fnUpdateUserStatus(this);" />--%>
                                                                                </td>
                                                                                <td width="5" class="grid-border-bottom">
                                                                                </td>
                                                                                <td width="1" bgcolor="#CCCCCC">
                                ...
                                <div class="QTPopupCntnr">
                                    ...
                                    <div class="gpBdrLeft">
                                        <div class="gpBdrRight">
                                            <div class="caption">
                                                <span id="lblTitle">Add New Patient</span>
                                            </div>
                                            ...
                                            <div class="content">
                                                <table width="100%" cellpadding="0" cellspacing="0">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            ...
                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="*"
                                                                ControlToValidate="txtFirstName" ValidationGroup="grpValidateExpertDetials" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                                        </td>
                                                        <td width="260">
                                                            <div class="titlebarLeftc">
                                                                <div class="titlebarRightc">
                                                                    <div class="titlebar" style="width: 250px;">
                                                                        <input type="text" id="txtFirstName" runat="server" class="validate[required]" value=""
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="260">
                                                            <div class="titlebarLeftc">
                                                                <div class="titlebarRightc">
                                                                    <div class="titlebar" style="width: 250px;">
                                                                        <input type="text" class="validate[required]" id="txtLastName" runat="server" value=""
                                                                            style="border: 0px; background: none; margin-top: 5px; width: 245px;" />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="260">
                                                            <div class="titlebarLeftc">
                                                                <div class="titlebarRightc">
                                                                    <div class="titlebar" style="width: 250px;">
                                                                        <input type="text" id="txtEmail" class="validate[required,custom[email]]" runat="server"
                                                    ...
                                                    <tr>
                                                        <td>
                                                            ...
                                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator4" ForeColor="Maroon"
                                                                ...
                                                                ErrorMessage="* Invalid date Format" ToolTip="* Invalid date Format e.g. MM/DD/YYYY" ValidationExpression="^((((0[13578])|([13578])|(1[02]))[\/](([1-9])|([0-2][0-9])|(3[01])))|(((0[469])|([469])|(11))[\/](([1-9])|([0-2][0-9])|(30)))|((2|02)[\/](([1-9])|([0-2][0-9]))))[\/]\d{4}$|^\d{4}$"></asp:RegularExpressionValidator>
                                                        </td>
                                                        <td width="260">
                                                            <div class="titlebarLeftc">
                                                                <div class="titlebarRightc">
                                                                    <div class="titlebar" style="width: 250px;">
                                                                        <asp:TextBox ID="txtdob" class="validate[required,custom[dateUS]]" runat="server" value="" Style="border: 0px; background: none;
                                                    ...
                                                    <tr>
                                                        <td>
                                                            ...
                                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ErrorMessage="*"
                                                                ValidationExpression="^[a-z0-9._-]{2,25}$" ControlToValidate="txtUserName" ValidationGroup="grpValidateExpertDetials"
                                                        ...
                                                        <td width="260">
                                                            <div class="titlebarLeftc">
                                                                <div class="titlebarRightc">
                                                                    <div class="titlebar" style="width: 250px;">
                                                                        <input type="text" id="txtUserName" class="validate[required,custom[username]]" runat="server" value="" style="border: 0px; background: none;
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="260">
                                                            <div class="titlebarLeftc">
                                                                <div class="titlebarRightc">
                                                                    <div class="titlebar" style="width: 250px;">
                                                                        <input type="text" id="txtPassword" class="validate[required]" runat="server" value="" style="border: 0px; background: none;
                                                                            margin-top: 5px; width: 245px;" />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            ...
                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="*"
                                                                ControlToValidate="txtPostCode" ValidationGroup="grpValidateExpertDetials"></asp:RequiredFieldValidator>
                                                        </td>
                                                        <td width="260">
                                                            <div class="titlebarLeftc">
                                                                <div class="titlebarRightc">
                                                                    <div class="titlebar" style="width: 250px;">
                                                                        <input type="text" id="txtPostCode" class="validate[required]" runat="server" onchange="javascript:fnLoadCountry();"
                                                                            value="" style="border: 0px; background: none; margin-top: 5px; width: 245px;" />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <input id="btnSaveDetails" type="button" onclick="UpdateValues(this);" class="default_button_3"
                                                                value="Save" />
                                                            <%-- <asp:Button ID="btnSaveDetails" CssClass="default_button_3" runat="server" Text="Save" ValidationGroup="grpValidateExpertDetials"
                                                                CausesValidation="true" OnClientClick="UpdateValues(this);" />--%>
