<%@ page title="" language="C#" masterpagefile="~/ControlPanel/AdminPanel.master" autoeventwireup="true" inherits="ControlPanel_ManageExpertDiaries, App_Web_zarixrtn" maintainscrollpositiononpostback="true" %>
                                                ...
                                                <table>
                                                    <tr>
                                                        <td style="width: 80px; text-align: left; vertical-align: top;">
                                                            <asp:Button ID="btnAddSlots" runat="server" CssClass="default_button_3" OnClick="btnAddSlots_Click"
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td align="right">
                                                                                        ...
                                                                                        <asp:Button ID="btnSaveSlot" CausesValidation="true" ValidationGroup="validateSlots"
                                                                                            runat="server" CssClass="default_button_3" Text="Save" OnClick="btnSaveSlot_Click" />&nbsp;
                                                                                        <asp:Button ID="btnCloseSlot" runat="server" Text="Close" CssClass="default_button_3" CausesValidation="false"
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td align="right">
                                                                                        ...
                                                                                        <asp:Button ID="btnMoveAppointment" CausesValidation="true" ValidationGroup="validateMSlots"
                                                                                            runat="server" CssClass="default_button_3" Text="Save" OnClick="btnSaveSlot_Click" />&nbsp;
                                                                                        <asp:Button ID="btnCloseMoveApp" runat="server" Text="Close" CssClass="default_button_3" CausesValidation="false"
