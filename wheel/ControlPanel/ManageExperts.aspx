<%@ page title="" language="C#" masterpagefile="~/ControlPanel/AdminPanel.master" autoeventwireup="true" inherits="ControlPanel_ManageExperts, App_Web_zarixrtn" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function FillEditDialog(editButton) {
            ...
            document.getElementById("lblTitle").innerHTML = "Edit Expert";
        ...
        function UpdateValues(e) {
            ...
            $.ajax({
                type: "POST",
                url: "../LinezWS_WHCS.asmx/fnSaveMedicalExpert",
        ...
        <tr>
            <td>
                <table width="968" border="0" cellspacing="0" cellpadding="0">
                                                                    ...
                                                                    <asp:ListView ID="lstUsers" runat="server">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <tr>
                                                                                ...
                                                                                <td class="grid-border-bottom">
                                                                                    <asp:CheckBox ID="CheckBox1" runat="server" Checked='<%# Eval("btIsActive") %>' onchange="javascript:fnUpdateUserStatus(this);" />
                    ...
                    <tr>
                        <td align="left" valign="top">
                            <div class="QTPopup" style="display: block">
                                ...
                                <div class="QTPopupCntnr">
                                    ...
                                    <div class="gpBdrLeft">
                                        <div class="gpBdrRight">
                                            <div class="caption">
                                                <span id="lblTitle">Add New Expert</span>
                                            </div>
