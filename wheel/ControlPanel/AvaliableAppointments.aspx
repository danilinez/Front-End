<%@ page title="" masterpagefile="~/ControlPanel/AdminPanel.master" language="C#" autoeventwireup="true" inherits="ControlPanel_AvaliableAppointments, App_Web_zarixrtn" %>
                                                            ...
                                                            <table width="100%" class="grid" border="0" cellspacing="0" cellpadding="0">
                                                                ...
                                                                <asp:ListView ID="lstAvailableSlots" runat="server" OnItemDataBound="lstAvailableSlots_ItemDataBound"
                                                                    ...
                                                                    <EmptyDataTemplate>
                                                                        <tr>
                                                                            <td colspan="4">
                                                                                No Appointment Exists on this date
                                                                            </td>
                                                                        </tr>
                                                                    </EmptyDataTemplate>
                                                                </asp:ListView>
