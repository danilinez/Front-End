<%@ page title="" language="C#" masterpagefile="~/UserPanels/UserPanel.master" autoeventwireup="true" inherits="UserPanels_Default, App_Web_uqe3rud5" %>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <asp:Button ID="btnAddNewCase" CssClass="gbtn_s" runat="server" Text="Add Case" CausesValidation="False"
                                                                                OnClick="btnAddNewCase_Click" Visible="false"/>
                                                                        </td>
                                                                        <td>
                                                                        </td>
                                                                    </tr>
                                                                        ...
                                                                        <td>
                                                                           <%-- <asp:Button ID="btnSearch" CssClass="gbtn_s" runat="server" Style="background: url(images/btn-search.png);
                                                                                width: 94px; height: 33px" CausesValidation="true" OnClick="btnSearch_Click" />--%>
                                                                                  ...
                                                                                  <asp:Button ID="btnSearch" CssClass="gbtn_s" runat="server" Text="Search" CausesValidation="False"
