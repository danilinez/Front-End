<%@ page title="" language="C#" masterpagefile="~/UserPanels/Doctor.master" autoeventwireup="true" inherits="UserPanels_Default, App_Web_s4f5inlf" %>
                                                                                    ...
                                                                                    <td>
                                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                            <tr>
                                                                                                ...
                                                                                                <td align="left">
                                                                                                    <asp:TextBox ID="tbTitle" class="field-220" runat="server"></asp:TextBox><asp:RequiredFieldValidator
                                                                                                        ID="RequiredFieldValidator1" runat="server" ControlToValidate="tbTitle" ValidationGroup="validation"
                                                                                            ...
                                                                                            <tr>
                                                                                                ...
                                                                                                <td align="left">
                                                                                                    <asp:TextBox ID="tbDescription" class="field-220" Rows="5" Style="resize: none;"
                                                                                                        TextMode="MultiLine" runat="server"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator2"
                                                                                                            runat="server" ControlToValidate="tbDescription" ValidationGroup="validation"
                                                                                                            ErrorMessage="*"></asp:RequiredFieldValidator>
                                                                                                </td>
                                                                                            </tr>
                                                                                        </table>
                                                                                ...
                                                                                <tr>
                                                                                    <td>
                                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                            <tr>
                                                                                                <td width="151" align="left">
                                                                                                    Attachment:<asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server"
                                                                                                        ControlToValidate="FileUpload1" ValidationGroup="validation" ErrorMessage="*"></asp:RequiredFieldValidator>
                                                                                                </td>
                                                                                    </td>
                                                                                    <td align="left">
                                                                                                    ...
                                                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                                        <tr>
                                                                                                            ...
                                                                                                            <td width="16" align="left">
                                                                                                                <a href='../AllDocuments/<%# Eval("sDocumentPath")%>' target="_blank">
                                                                                                            ...
                                                                                                            <td width="16" align="left">
                                                                                                                <asp:ImageButton ID="btnDeleteDocument" runat="server" src="images/icon-delete.png"
                                                                                                                    Width="9" Height="10" CommandArgument='<%# Eval("iDoctorDocumentID")%>' CommandName="deleteDocument" />
                                                                                                            </td>
                                                                                                            <td align="left">
                                                                                                                <asp:ImageButton ID="btnEditDocument" runat="server" src="images/icon-view-edit.png"
                                                                                                                    Width="9" Height="10" CommandArgument='<%# Eval("iDoctorDocumentID")%>' CommandName="editDocument" />
                                                                                                            </td>
