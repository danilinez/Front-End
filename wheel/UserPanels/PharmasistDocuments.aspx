<%@ page language="C#" title="" masterpagefile="~/UserPanels/Pharmasist.master" autoeventwireup="true" inherits="UserPanels_PharmasistDocuments, App_Web_sesurbpw" %>
                                            ...
                                            <tr>
                                                <td>
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                            <tr>
                                                                                                <td align="left">
                                                                                                    Patient Documents</td>
                                                                                                <td width="15">
                                                                                                    <img src="images/bullet-heading-right.png" width="15" height="16" /></td>
                                                                                            </tr>
                                                                                        </table>
                                                                                    </td>
                                                                                    <td>
                                                      ...
                                                      ID="RequiredFieldValidator1" runat="server" ControlToValidate="tbTitle" ValidationGroup="validation" ErrorMessage="*"></asp:RequiredFieldValidator></td>
                                                                                                <td align="left">
                                                      ...
                                                      ID="RequiredFieldValidator2" runat="server" ControlToValidate="tbDescription" ValidationGroup="validation" ErrorMessage="*"></asp:RequiredFieldValidator></td>
                                                                                                <td align="left">
                                                                                                    <asp:TextBox ID="tbDescription" class="field-220" rows="5" style="resize:none;" TextMode="MultiLine" runat="server"></asp:TextBox>
                                                                                ...
                                                                                <tr>
                                                                                    <td>
                                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                            <tr>
                                                                                                <td width="151" align="left">
                                                                                                    Attachment: <asp:RequiredFieldValidator
                                                      ID="RequiredFieldValidator3" runat="server" ControlToValidate="FileUpload1" ValidationGroup="validation" ErrorMessage="*"></asp:RequiredFieldValidator></td>
                                                                                                <td align="left">
                                                                            ...
                                                                            <table width="500" border="0" cellspacing="0" cellpadding="0" class="mainbox">
                                                                                ...
                                                                                <tr>
                                                                                    <td>
                                                                                        &nbsp;</td>
                                                                                    <td>
                                                                                        <asp:ListView ID="lstDocuments" runat="server" 
                                                  onprerender="lstDocuments_PreRender" 
                                                  onitemcommand="lstDocuments_ItemCommand" >
                                                            ...
                                                            Action
                                                                                ...
                                                                                &nbsp;
                                                                                                                        ...
                                                                                                                        <td width="16" align="left">
                                                                                                                            <asp:ImageButton ID="btnDeleteDocument" runat="server" src="images/icon-delete.png" width="9" height="10" CommandArgument='<%# Eval("iPharmasistDocumentsID")%>' CommandName="deleteDocument" />
                                                                                                                        </td>
                                                                                                                        <td align="left">
                                                                                                                            <asp:ImageButton ID="btnEditDocument" runat="server" src="images/icon-view-edit.png" width="9" height="10" CommandArgument='<%# Eval("iPharmasistDocumentsID")%>' CommandName="editDocument" />
                                                                                                                        </td>
                            ...
                            <table width="197" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td width="63" align="left">
                                        <asp:ImageButton ID="btnSave" src="images/btn-save.png" 
                                width="63" height="25" runat="server" ValidationGroup="validation" 
                                onclick="btnSave_Click"/>
                                    </td>
                                    <td align="left">
                                        &nbsp;</td>
                                    <td width="63" align="left">
                                        <asp:ImageButton ID="btnReset" 
                                src="images/btn-reset.png" width="63" height="25" runat="server" 
                                onclick="btnReset_Click" />
                                    </td>
                                    <td align="left">
                                        &nbsp;</td>
                                    <td width="63" align="left">
                                        <asp:ImageButton ID="btnCancel" src="images/btn-cancel.png" width="63" height="25" runat="server" />
                                    </td>
                                </tr>
                            </table>
                        </td>
