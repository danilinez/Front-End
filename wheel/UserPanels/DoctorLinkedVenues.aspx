<%@ page title="" language="C#" masterpagefile="~/UserPanels/Doctor.master" autoeventwireup="true" inherits="UserPanels_Default, App_Web_01jbwper" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <script type="text/javascript">
        ...
        var newEntry;
        var row;
        var idiVenueID, idiContactID, idsDoctorName, idsPostcode, idsAddress, sLocationName, idsCountry, hfAdminCompanyID;
        ...
        function FillEditDialog(editButton) {
            ...
            document.getElementById("lblTitle").innerHTML = "Edit Doctor Venue";
        ...
        function UpdateValues(e) {
            ...
            idiContactID = '<%=Session["iContactID"]%>';
            ...
            $.ajax({
                ...
                data: "{'iVenueID':'" + idiVenueID + "','iContactID':'" + idiContactID + "','sPostCode':'" + idsPostcode + "','sAddress':'" + idsAddress + "','sLocationName':'" + idsLocationName + "','iUserTypeID':'2','sPhoneNumber':'','sMobile':'', 'newEntry':'" + newEntry + "','iAdminCompanyID':'" + hfAdminCompanyID + "', 'sCountry':'" + idsCountry + "'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (response) {
                    var result = response.d;
                                                                ...
                                                                <table width="100%" class="grid" border="0" cellspacing="0" cellpadding="0">
                                                                    <thead>
                                                                        <tr>
                                                                            ...
                                                                            <td style="width: 120px" class="grid-header">
                                                                                Location Name
                                                                            </td>
                                                                            <td width="5" class="grid-header">
                                                                            </td>
                                ...
                                <div class="QTPopupCntnr">
                                    ...
                                    <div class="gpBdrLeft">
                                        <div class="gpBdrRight">
                                            <div class="caption">
                                                <span id="lblTitle">Add Doctor Venue </span>
                                            </div>
                                            ...
                                            <div class="content">
                                                <table width="100%" cellpadding="0" cellspacing="0">
                                                    ...
                                                    <%--<tr>
                                                        <td>
                                                            Expert Name<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server"
