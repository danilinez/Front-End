<%@ page title="" language="C#" masterpagefile="~/UserPanels/Doctor.master" autoeventwireup="true" inherits="UserPanels_Default, App_Web_ej0wxnyr" %>
                                                                                            ...
                                                                                            <tr>
                                                                                                ...
                                                                                                <td colspan="5">
                                                                                                    <asp:DropDownList ID="ddlMedicalExperts" CssClass="field-220" Width="160px" runat="server"
                                                                                                        AutoPostBack="True" Enabled="false" OnSelectedIndexChanged="ddlMedicalExperts_SelectedIndexChanged">
                                                                                                    </asp:DropDownList>
                                                                                                </td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                ...
                                                                                <tr>
                                                                                    <td style="width: 140px">
                                                                                        ...
                                                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ControlToValidate="ddlLocation"
                                                                                            InitialValue="" runat="server" ErrorMessage="*" ValidationGroup="validateSlots"></asp:RequiredFieldValidator>
                                                                                    </td>
                                                                                    <td>
