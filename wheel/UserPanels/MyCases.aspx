<%@ page title="" masterpagefile="~/UserPanels/Client.master" language="C#" autoeventwireup="true" inherits="UserPanels_MyCases, App_Web_ej0wxnyr" %>
                                                        ...
                                                        <td width="16" align="left">
                                                            <a href="#">
                                                                <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                                                    <ContentTemplate>
                                                                        <asp:ImageButton ID="imgViewButton0" runat="server" ImageUrl="images/icon-view.png" />
                                                                    </ContentTemplate>
                                                                </asp:UpdatePanel>
                                                            </a>
                                                        </td>
