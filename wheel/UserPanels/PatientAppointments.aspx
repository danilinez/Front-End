<%@ page language="C#" title="" masterpagefile="~/UserPanels/Client.master" autoeventwireup="true" inherits="UserPanels_PatientAppointments, App_Web_iiwsqckp" %>
                    ...
                    <tr> 
                        <td>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                      ...
                                      <%--<tr>
                                                  <td class="grid-bg-color grid-border-bottom"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                      <td width="5" height="30"></td>
                                                      <td width="176" align="left">John</td>
                                                      <td width="5"></td>
                                                      <td width="1" bgcolor="#CCCCCC"></td>
                                                      <td width="5"></td>
                                                      <td width="183" align="left">Kathleen</td>
                                                      <td width="5"></td>
                                                      <td width="1" bgcolor="#CCCCCC"></td>
                                                      <td width="5"></td>
                                                      <td width="162" align="left">10/10/2012 12:00 </td>
                                                      <td width="5"></td>
                                                      <td width="1" bgcolor="#CCCCCC"></td>
                                                      <td width="5"></td>
                                                      <td width="206" align="left">Smith</td>
                                                      <td width="5"></td>
                                                      <td width="1" bgcolor="#CCCCCC"></td>
                                                      <td width="5"></td>
                                                      <td width="103" align="left">Attended</td>
                                                      <td width="5"></td>
                                                      <td width="1" bgcolor="#CCCCCC"></td>
                                                      <td width="5"></td>
                                                      <td width="61" align="left"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                          <tr>
                                                            <td width="9">&nbsp;</td>
                                                            <td width="16" align="left"><a href="#"><img src="images/icon-view.png" width="10" height="10" /></a></td>
                                                            <td width="16" align="left"><a href="#"><img src="images/icon-delete.png" width="9" height="10" /></a></td>
                                                            <td align="left"><a href="#"><img src="images/icon-view-edit.png" width="9" height="10" /></a></td>
                                                            <td align="left" width="9">&nbsp;</td>
                                                          </tr>
                                                      </table></td>
                                                      <td width="5"></td>
                                      ...
                                      <tr>
                                                  <td class="grid-border-bottom"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                      <td width="5" height="30"></td>
                                                      <td width="176" align="left">Smith</td>
                                                      <td width="5"></td>
                                                      <td width="1" bgcolor="#CCCCCC"></td>
                                                      <td width="5"></td>
                                                      <td width="183" align="left">Kathleen</td>
